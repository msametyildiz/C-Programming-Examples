...
int main(){
	...
	scanf("%d",&istek-1);
	printf("%s %s kisisinin adresi : %s , telefon numarası : %s ,posta kodu : %s",adresdefteri[istek].ad,adresdefteri[istek].soyad,adresdefteri[istek].adres,adresdefteri[istek].tel,adresdefteri[istek].postakodu);
	return 0;
}
